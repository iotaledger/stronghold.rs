...
//         Ok(())
//     }
//     /// Gets the value associated with the specified key.  If the key could not be found in the [`Cache`], creates
//     /// and inserts the value using a specified `func` function.
//     ///
//     /// # Example
//     /// ```
//     /// use iota_stronghold_new::types::Cache;
