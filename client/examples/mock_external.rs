...
//     fn receive(&mut self, ctx: &Context<Self::Msg>, _msg: StartTest, sender: Sender) {
//         let mock = ctx.select("/user/mock/").expect(line_error!());
//         mock.try_tell(MockExternalMsg::InterfaceMsg(InterfaceMsg::CreateVault), sender.clone());
...
//         mock.try_tell(
//             MockExternalMsg::InterfaceMsg(InterfaceMsg::ReadData(0, None)),
//             sender.clone(),
//         );
//         mock.try_tell(MockExternalMsg::InterfaceMsg(InterfaceMsg::ListIds(0)), sender);
