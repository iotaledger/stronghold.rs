...
mod comm {
    ...
    pub use iota::{ActorSystem, Multiaddr, PeerId, RelayDirection, ResultMessage, Stronghold};
    pub use iota_stronghold as iota;
    pub use log::*;
    ...
    pub fn parse(input: String) -> Result<HashMap<PeerId, Multiaddr>, Box<dyn Error>> {
    ...
    pub fn parse_entry(input: String) -> Result<(PeerId, Multiaddr), Box<dyn Error>> {
