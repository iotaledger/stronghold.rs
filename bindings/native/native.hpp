...
uint8_t *generate_ed25519_keypair(StrongholdWrapper *stronghold_ptr,
                                  const char *key_c,
                                  const char *record_path_c);

bool generate_seed(StrongholdWrapper *stronghold_ptr, const char *key_c);

bool derive_seed(StrongholdWrapper *stronghold_ptr, const char *key_c, uint32_t address_index);
